...
INSERT INTO `sys_user` (`id`, `account`, `password`, `username`, `nickname`, `avatar`, `gender`, `email`, `mobile`,
                        `status`, `order_num`, `remark`,
                        `create_at`, `update_at`)
VALUES (1, 'zxd', 'zxd', 'zxd', 'zxd',
        'https://avataaars.io/?avatarStyle=Circle&topType=Hat&accessoriesType=Prescription02&facialHairType=BeardLight&facialHairColor=BrownDark&clotheType=Hoodie&clotheColor=Heather&eyeType=Default&eyebrowType=Default&mouthType=Default&skinColor=Light',
        0, 'zxdlovejava@gmail.com', '', 0, 0, 0, '2022-08-11 06:19:45', '2022-08-27 01:41:43')